  ...
  return (
    <div>
      ...
      <div className="h-10 bg-black flex justify-between px-36 py-4 text-white items-center">
        ...
        <NavLink to='/Makeup'><p> Makeup</p></NavLink>
        <NavLink to='/Skincare'><p> Skincare</p></NavLink>
        <NavLink to='/Hair'><p> Hair</p></NavLink>
        <NavLink to='/Fragrance'><p> Fragrance</p></NavLink>
        <NavLink to='/Tools'><p> Tools & Brushes</p></NavLink>
        <NavLink to='/Bath'><p> Bath & Body</p></NavLink>
        <NavLink to='/Mini'><p> Mini Size</p></NavLink>
        <NavLink to='/Gifts'>
        ...
        <NavLink to='/Under'><p>Beauty Under $20</p></NavLink>
        <NavLink to='/Sale'><p>Sale & Offers</p></NavLink>
      </div>
      {loading ? (
